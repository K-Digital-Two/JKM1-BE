...
public class DataDao implements DataInterface {
	...
	@Override
	public Map<String, Object> getShipDatas() { // info 테이블 가져오기
	...
	@Override
	public Map<String, Object> getShipData(int shipId) { // info 테이블 schedules_ship_shipId 컬럼 특정 값 가져오기
		Map<String, Object> ret = new HashMap<>();
	...
	@Override
	public Map<String, Object> getShiplogDatas() {
		String sqlString = "select * from shiplog";
		Map<String, Object> ret = new HashMap<>();
		ret.put("sql", sqlString);
		try {
	...
	@Override
	public Map<String, Object> getShiplogData(int shipId) {
		Map<String, Object> ret = new HashMap<>();
		String sqlString = String.format("select * from shiplog where shipId=%d", shipId);
		ret.put("sql", sqlString);
		try {
			ShiplogVO data = jdbcTemplate.queryForObject(sqlString, new BeanPropertyRowMapper<ShiplogVO>(ShiplogVO.class));
			ret.put("data", data);
		} catch (Exception e) {
			ret.put("data", null);
		}
