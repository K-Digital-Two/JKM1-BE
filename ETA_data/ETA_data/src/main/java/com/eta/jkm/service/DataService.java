...
public class DataService {
	...
	public List<ShiplogVO> getShiplogDatas() {
		Map<String, Object> map = dataDao.getShiplogDatas();
		List<ShiplogVO> list = (List<ShiplogVO>) map.get("data");
		if (list != null)
			logDao.addLog("get", (String) map.get("sql"), true);
		else
			logDao.addLog("get", (String) map.get("sql"), false);
	...
	public ShiplogVO getShiplogData(int shipId) {
		Map<String, Object> map = dataDao.getShiplogData(shipId);
		ShiplogVO data = (ShiplogVO) map.get("data");
		if (data != null)
			logDao.addLog("get", (String) map.get("sql"), true);
		else
			logDao.addLog("get", (String) map.get("sql"), false);
