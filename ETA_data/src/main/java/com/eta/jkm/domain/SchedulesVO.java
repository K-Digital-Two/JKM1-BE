...
public class SchedulesVO {
	...
	public SchedulesVO(int ship_shipId, String arrivalPort_arrivalName, String departure, Date departTime) {
		super();
	...
	public String toString() {
		return "SchedulesVO [ship_shipId=" + ship_shipId + ", arrivalPort_arrivalName=" + arrivalPort_arrivalName
				+ ", departure=" + departure + ", departTime=" + departTime + "]";
	}
