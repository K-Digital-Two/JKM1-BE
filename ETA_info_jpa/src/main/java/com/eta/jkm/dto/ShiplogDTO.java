...
public class ShiplogDTO {
	...
	public ShiplogDTO(int shipId, String shipName, String shipUse, String insertTime, double shipLat, double shipLon,
	...
	public String toString() {
		return "ShiplogDTO [shipId=" + shipId + ", shipName=" + shipName + ", shipUse=" + shipUse + ", insertTime="
